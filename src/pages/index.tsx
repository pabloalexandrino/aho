    ...
    const handleSubmitLead = async (event: { preventDefault: () => void }) => {
        ...
        try {
            ...
            await fetch('/api/addToList', {
                ...
                setLoading(false)
                redirectTo('https://go.rendacommilhas.com.br/form/998f6231-2ff4-4117-8e1c-621e43945d0d')
            })
        } catch (error) {
    ...
    return (
        <>
            ...
            <div
                ...
                <div className='text-white px-6 md:px-24 mt-40 md:max-w-3xl lg:max-w-5xl sm:col-span-2 col-span-1'>
                    ...
                    <div className='flex gap-6 mt-10 flex-col sm:flex-row'>
                        <div className='flex items-center gap-2'>
                            <BlurImage src={'/calendar.webp'} width={30} height={30} />
                            <span className='opacity-50'>17 e 19 de Julho</span>
                        </div>

                        <div className='flex items-center gap-2'>
                            <BlurImage src={'/ticket.webp'} width={30} height={30} />
                ...
                <div></div>
                <div className='flex justify-center flex-col items-center my-24 col-span-2'>
