...
export default function BlockedPage({ show = true, offer }: BlockedProps) {
    ...
    return show ? (
        <>
            ...
            <section className="relative mx-auto py-12 md:py-24 px-6 bg-[url(/bg-2.webp)] bg-cover bg-fixed">
                <Blur direction="right" />
                <h2 className="font-bold uppercase text-black text-center text-2xl md:text-3xl max-w-4xl mx-auto mb-8">
                    Senhora de{' '}
                    <span className="bg-primary">
                        75 anos conseguiu + R$ 10.000,00
                    </span>{' '}
                    em menos de 2 meses, você não vai?
                </h2>

                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-8 md:mt-24">
                    <div className="relative h-44 sm:h-64">
                        <BlurImage
                            src="/depoimentos/senhora.webp"
                            alt="Senhora de 75 anos"
                            layout="fill"
                    ...
                    <div className="text-center text-black">
                        <p className="text-justify text-lg leading-relaxed mb-8">
                            Você tem <strong>professores</strong> para te
                            assessorar durante toda sua jornada de aprendizagem,
                            desde o básico até a criação completa do seu{' '}
                            <strong>segundo salário.</strong>
                        </p>
            ...
            <section className="relative py-12 md:py-24 px-8">
                <Blur />
                <FloatBlocks />
                <div className="text-center">
                    <h2 className="font-bold text-white/80 text-3xl md:text-5xl max-w-6xl mx-auto">
                        O <span className="text-black bg-primary">SAV</span> -{' '}
                        <span className="text-white text-glow animate-pulse">
                            S
                        </span>
                        aque{' '}
                        <span className="text-white text-glow animate-pulse">
                ...
                <div className="grid gap-2 max-w-5xl mx-auto mt-8">
                    <p className="font-light text-justify text-lg leading-relaxed">
                        É uma metodologia simples que vai te ajudar a ter uma
                        renda extra todos os meses sem se matar de trabalhar,
                        apenas mudando algumas práticas do seu dia a dia.
                    </p>

                    <Divider />

                    <div className="mx-auto text-xl overflow-x-auto">
                        <table className="table table-zebra table-fixed mx-auto w-full">
                            <thead>
                                <tr>
                                    <th>
                                        <div className="flex items-center text-[#F5A09E]">
            ...
            <section className="relative mx-auto py-12 sm:py-24 px-6 bg-[url(/bg-2.webp)] bg-cover bg-fixed">
                ...
                <div className="grid text-center gap-8 max-w-xl mx-auto mt-12 mb-8 md:mt-24">
                    <div>
                        <h2 className="font-bold text-black w-fit bg-primary text-2xl md:text-3xl max-w-2xl mx-auto mb-8">
                            RISCO ZERO
                        </h2>

                        <p className="text-black leading-normal mb-8 text-center">
                            Se neste período você seguir à risca e fizer tudo o
                            que eu ensino e ainda assim não recuperar o valor
                            investido no ecosistema e não conseguir gerar uma
                            renda extra,{' '}
                            <strong>
                                eu devolvo o dobro do valor investido.
                            </strong>
                            <br />
                            <br />
                            Mesmo depois de você ter consumido todo o conteúdo.
                            <br />
                            <br />É isso mesmo.{' '}
                            <strong>
                                Eu vou te dar o meu dinheiro se você não ganhar
                                dinheiro no Renda com Milhas.
                            </strong>
                            <br />
                            <br />
                        </p>
                        <div className="text-xl md:text-2xl w-fit mx-auto p-4 border-error border rounded-xl text-white bg-error animate-pulse">
            ...
            <section className="relative mx-auto py-12 sm:py-24 px-6 bg-[url(/bg-2.webp)] bg-cover bg-fixed">
                ...
                <div className="container mx-auto max-w-5xl mb-12">
                    <div className="grid gap-8">
                        <div className="relative h-[200px] lg:h-96 mb-1">
                            <BlurImage
                                layout="fill"
                                src="/saque.webp"
                                alt="Caixa"
                        ...
                        <div>
                            <h2 className="font-bold text-center text-black text-2xl md:text-3xl mx-auto mb-8">
                                VOCÊ ESTÁ A UM PASSO APENAS DE RECEBER DEPÓSITOS
                                MENSAIS NA SUA CONTA
                            </h2>
                            <p className="text-black text-justify mb-6 md:mb-12">
                                Tenha um 2º salário todos os meses e fazer ao
                                menos 2 viagens de graça ao ano! Pessoas comuns,
                                com pouca condição financeira, ou até mesmo que
                                nunca fizeram uma viagem de avião, estão
                                conseguindo realizar sonhos e melhorar de vida
                                com o SAV = Saques Automáticos Vitalícios
                            </p>
                        </div>
                    </div>
                    <div className="grid gap-8 sm:grid-cols-3">
                        <Panda
                            player={process.env.NEXT_PUBLIC_PLAYER_ID!}
                            video="b7159580-0152-4fa9-a0d2-2a7cd85211fd"
                            vertical
                        />
                        <Panda
                            player={process.env.NEXT_PUBLIC_PLAYER_ID!}
                            video="dab813e5-9001-478b-b975-f0794111b54e"
                            vertical
                        />
                        <Panda
                            player={process.env.NEXT_PUBLIC_PLAYER_ID!}
                            video="7d695fe4-a1b9-4cbc-88fb-15b6b0d08378"
                            vertical
                        />
                    </div>
                    <div className="mx-auto text-center font-bold text-lg max-w-3xl text-black md:text-3xl mt-8">
                        Pessoas comuns, com condições parecidas ou até piores
                        que a sua criando um{' '}
                        <strong className="bg-primary">
                            2º salário mensal.
                        </strong>
                    </div>
                    <div className="grid gap-4 md:grid-cols-3 mt-12">
                        <div className="relative hover:z-10 h-[400px] box-glow rounded-xl">
                            <BlurImage
                    ...
                    <div className="mx-auto text-center max-w-3xl text-black text-3xl mt-8">
                        Não faz sentido ficar de fora, não é? <br />
                        Ainda mais com{' '}
                        <strong className="bg-warning">RISCO ZERO!</strong>
                    </div>
                </div>
                {offer && <CallToAction />}
            </section>
            ...
            <section className="relative mx-auto py-12 sm:py-24 px-6 bg-[url(/bg.webp)] bg-fixed bg-contain bg-no-repeat bg-right">
                <Blur direction="right" />
                <Blur />
                <FloatBlocks />
                <div className="container mx-auto">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 max-w-5xl mx-auto">
                        <div className="w-full sm:w-[40%] md:w-[30%] card card-compact bg-base-100 shadow-xl hover:scale-105 transition-all duration-500 hover:box-glow hover:z-10">
            ...
            <section className="relative mx-auto py-12 sm:py-24 px-6 bg-[url(/bg-2.webp)] bg-cover bg-fixed bg-no-repeat">
                <div className="container mx-auto max-w-5xl">
                    ...
                    <div className="flex flex-col gap-4 mb-12">
                        <div className="card lg:card-side bg-white text-black shadow-xl box-glow hover:scale-105 transition-all duration-500">
            ...
            <section className="relative w-full bg-black px-6 py-12">
                <div className="container mx-auto max-w-4xl">
                    ...
                    <div className="bg-base-100 relative overflow-x-auto border-dashed border rounded-xl md:p-8 border-primary box-glow md:hover:scale-105 transition-all duration-500">
