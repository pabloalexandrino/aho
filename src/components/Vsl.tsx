        ...
        <>
            ...
            <section className='flex justify-center bg-center bg-[url(/bg.webp)] bg-cover pb-12'>
                ...
                <div className='container px-6 md:mt-6'>
                    ...
                    <p className='text-lg md:text-3xl max-w-4xl mx-auto text-center text-white font-bold mt-4'>
                        COMO CRIAR UM SEGUNDO SALÁRIO DE{' '}
                        <span className='bg-primary text-black'>
                            R$1.000 A R$4.000
                        </span>{' '}(ou mais) TODOS OS MESES!
                    </p>

                    <div className='my-12 w-full max-w-5xl flex mx-auto relative'>
                        <div
                            id='overlay'
                    ...
                    <div className='mt-2 text-center text-white relative flex justify-center w-full'>
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                            fill='none'
                            viewBox='0 0 24 24'
