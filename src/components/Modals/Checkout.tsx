...
export default function Checkout() {
    ...
    const handleSubmit = async (event: { preventDefault: () => void }) => {
        ...
        try {
            ...
            await schema
                .validate({ name, email, whatsapp, instagram }, { abortEarly: false })
                .then(async () => {
    ...
    return (
        <>
            ...
            <label
                htmlFor='checkout'
                className='modal modal-bottom sm:modal-middle bg-black/70 backdrop-blur-lg'
            >
                <label htmlFor='' className='relative modal-box box-glow bg-black/80'>
                    <label
                        htmlFor='checkout'
